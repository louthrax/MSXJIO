...
z88dk-z80asm -b -d -l -m -DJIO -Oobj -o=jio_dos2.bin p1_main.asm p3_paging.asm drv_jio.asm p0_kernel.asm
z88dk-appmake +glue -b obj/jio_dos2 --filler 0xFF --clean

z88dk-appmake +rom  -b obj/jio_dos2__.bin -o ./jio_dos2.rom -s 32768 --org 0

z88dk-appmake +rom  -b obj/jio_dos2__.bin -o ./jio_dos2_64k.rom -s 65536 --org 16384 --fill 0xFF
...
cp ./jio_dos2.rom /mnt/DataBackupNAS/msxftp/RSDISK
rm -r -f ./obj rdate.inc
